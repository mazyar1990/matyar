                                    ...
                                    <div class="grid gap-6 mb-6 md:grid-cols-4">
                                        <div>
                                            ...
                                            <datalist id="project-list">
                                                <template x-for="project in projectNames" :key="project.id">
                                                    <option :value="project.name" :data-id="project.id"></option>
                                                </template>
                                            </datalist>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <select id="from_to_select" name="lang" x-model="selectedFileLang" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    ...
    function translationTool() {  
        return {  
            ...
            handleProjectInput() {
                ...
                if (this.projectName === this.lastProjectName) {
                    return;
                }
                
                // Check if the project name exists in our array
            ...
            checkProjectName() {
                ...
                // Check if project name exists in our projectNames array
                const matchedProject = this.projectNames.find(project => 
                    project.name.toLowerCase() === this.projectName.toLowerCase()
                );
                
                if (matchedProject) {
                    // Existing project - fetch its details
                    this.isNewProject = false;
                    this.findProject();
                } else {
                ...
                this.lastProjectName = this.projectName;
            },
            findProject() {
                if (!this.projectName) {
                    return;
